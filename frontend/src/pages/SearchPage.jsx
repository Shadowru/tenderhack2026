...
function ResultCard({ item, idx, onClickItem, query, userId, favoriteIds, onToggleFavorite }) {
      ...
      {onToggleFavorite && (
        <div className="flex items-center justify-end gap-2 mt-2 pt-2 border-t border-gray-50">
          <button type="button"
            ...
            className="flex items-center gap-1 px-2 py-1 rounded text-xs transition-colors hover:bg-portal-red-light"
            style={{ color: favoriteIds?.has(item.id) ? '#E53935' : '#999' }}>
